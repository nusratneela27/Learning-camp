  ...
  return (
    <div className="card card-compact w-full bg-base-100 shadow-xl">
      ...
      <div className="card-body">
        ...
        <button
          onClick={() => handleSelectClass(courses)}
          className=" bg-gradient-to-r from-slate-900 via-slate-600 to-slate-200 py-2 rounded ms-3 font-bold text-white"
        >
          <Link>Select Classes</Link>
        </button>
      </div>
    </div>
  );
